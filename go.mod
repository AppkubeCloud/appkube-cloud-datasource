module github.com/appkube/cloud-datasource
...
require (
	...
	github.com/yesoreyeram/grafana-infinity-datasource v1.4.0
	github.com/yesoreyeram/grafana-plugins/macros v0.0.0-20230116171827-bbd62732ecdf
